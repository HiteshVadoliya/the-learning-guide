...
<head>
  ...
  <title>Sponsor School payment</title>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Your Payment for Sponsore school Successfully</h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hi <?php echo $name; ?>,</b><br>
                            Your payment for sponsore school successfully.
                                ...
                                <td style="width:200px;background:#008000;">
                                  <pre>
                                    <table border="1">
                                      ...
                                      <tr>
                                        <td><?php echo $paypal['txn_id'] ?></td>
                                        <td><?php echo $paypal['item_name1'] ?></td>
                                        <td><?php echo $paypal['payer_email'] ?></td>
                                        <td><?php echo $paypal['payment_gross'] ?></td>
                                      </tr>
                                    </table>
