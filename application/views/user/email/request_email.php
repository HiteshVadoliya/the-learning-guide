                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>New <?= $type; ?> profile confirmation</h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            ...
                            <p style="padding: 15px 0;">
                              We received your request to create a <?php echo $type ?> profile for <?php echo $profile_name ?>, thank you! </br>
                            </p>
                            <p style="padding: 15px 0;">
                            Once approved, the new profile will be uploaded to our database and a link will be sent to your address. </p>
                          </td>
                        </tr>                       
                        <tr>
