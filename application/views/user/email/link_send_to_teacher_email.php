                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>New profile confirmation</h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hello <?= $name ?>,</b><br>
                           Thank you for approving our request to create a profile for our database. Your profile is now live! If you would like to view your profile, please click on the below button. 
                          </td>
                        </tr>
                        <tr>
                          <td>
