...
<head>
  ...
  <title><?php echo $type; ?> Approval required </title>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                            <h1>Profile Approval Notification </h1>
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                            <b>Hello  <?php echo $profile_name ?>,</b><br>
                            <p style="padding: 15px 0;">
                              Kelly Evagelakos has requested that we create/update your profile in our Australian school and teacher database. We help students and parents connect with teachers and schools to enhance their learning experience. 
                            </p>
                            </br></br>
                            <p style="padding: 15px 0;">
                              If you would like us to proceed, please click the below approval button and a representative will be in touch shortly to confirm your details. 
                            </p>

                            <!-- <strong><?php echo $name; ?></strong> has nominated as your profile in our database as <?php echo $type; ?>.
                            If you want with us as <?php echo $type; ?> profile. please click on Approve button. -->
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                              <tr>
                                <td style="width:200px;background:#008000;">
                                  ...
                                  style="background-color:#008000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Approve</a>
                                    <!--[if mso]>
                                      </center>
                                    </v:rect>
                                  <![endif]--></div>
