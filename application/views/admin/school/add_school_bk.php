         ...
         <div class="box-body">
            <div class="row">
               <div class="col-lg-6">
                  ...
                  ?>
                  <div class="form-group" id="sector" <?php echo $disp_hide; ?>>
                  ...
                  <div class="form-group">
                     ...
                     <label>Teaching Staff<span class="star-mend">*</span></label>
                     <?php
                     ...
                     <select name="no_of_teachers" class="form-control">
                        ...
                        foreach ($noTeacherArr as $teacher_key => $teacher) {
                           if(isset($school)) {
                              ...
                              $sel_teacher = (array_key_exists($teacher_key, $noTeacherArr)) ? 'selected' : '';
                           }
                        ?>
               ...
               <div class="col-lg-6">
                  ...
                  <div class="form-group <?= $hide; ?>" id="special_need_category_div">
