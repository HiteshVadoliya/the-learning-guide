<div class="pull-right col-md-12">
   <form action="<?php echo ADMIN_LINK; ?>Importschool\import_special" id="form-slider" class="" role="form" method="POST" enctype="multipart/form-data" >   
      ...
      <div class="col-md-6">
         ...
         <a href="<?php echo ASSETPATH.'special_type_import.csv' ?>" class="btn btn-md btn-info">Download Sample</a>
         <a href="<?php echo ASSETPATH.'special-information_import.csv' ?>" class="btn btn-md btn-info">Download Information</a>
      </div>
   </form>
   <form id="export_schools" method="post" action="<?php echo ADMIN_LINK.'Exportschool/export_special' ?>">
     <div>
...
if(isset($school)) {
?>
<form role="form" action="<?= ADMIN_LINK.'School/create_update_school_special/'.$school['id'] ?>" method="post" id="schoolForm2" enctype="multipart/form-data">
<?php
}
else {
?>
<form role="form" action="<?= ADMIN_LINK.'School/create_update_school_special' ?>" method="post" id="schoolForm2" enctype="multipart/form-data">
<?php
}
?>
      ...
      <div class="row">
         <div class="col-lg-6">
            ...
            <div class="form-group">
               ...
               <textarea rows="5" required type="text" name="corporate" class="form-control corporate_no" placeholder="Corporate Number"><?php if(isset($school)) { echo $school['corporate_no']; } ?></textarea>
            </div>
            ...
            <div class="form-group">
               <label>Speech Pathologist Onsite<span class="star-mend">*</span></label>
               <select name="speech_phthologist" class="form-control">
                  <option value="">--Select--</option>
                  <option value="1" <?php if(isset($school)) { if($school['speech_phthologist'] == '1') { echo 'selected'; } } ?>>Yes</option>
                  <option value="0" <?php if(isset($school)) { if($school['speech_phthologist'] == '0') { echo 'selected'; } } ?>>No</option>
               </select>
            </div>

            <div class="form-group">
               <label>Occupational Therapist Onsite<span class="star-mend">*</span></label>
               <select name="occupational_therapist" class="form-control">
                  <option value="">--Select--</option>
                  <option value="1" <?php if(isset($school)) { if($school['occupational_therapist'] == '1') { echo 'selected'; } } ?>>Yes</option>
                  <option value="0" <?php if(isset($school)) { if($school['occupational_therapist'] == '0') { echo 'selected'; } } ?>>No</option>
               </select>
            </div>
            ...
            <div class="row">
               <div class="col-md-6">
                   ...
                   <div class="form-group">
                      ...
                      <!-- <input type="text" class="form-control" name="ib_diploma_programme" value="<?php if(isset($school)) { echo $school['dep_principal']; } ?>" placeholder="IB Diploma Programme"> -->
                   </div>
