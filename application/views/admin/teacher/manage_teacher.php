...
<section class="content-header">
   <h1><i class="fa fa-university"></i>&nbsp;Manage Teacher</h1>
</section>
   ...
   <div class="box">
      <div class="box-header with-border">
         ...
         <div class="pull-right">
            <a href="<?= base_url(ADMIN.'add-teacher') ?>" class="btn btn-info btn-flat"> <i class="fa fa-plus"> </i> Add Teacher</a>
         </div>
      </div>
      <div class="box-body">
         <div class="row">
...
function gettour(page_num) {
   ...
   $.ajax({
      type: 'POST',
      url: '<?php echo base_url(ADMIN); ?>Teacher/ajax_teacher/'+page_num,
