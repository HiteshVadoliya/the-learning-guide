...
<section class="content-header">
   ...
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Edit Content Policy</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add Content Policy</h1>
   <?php
   }
   ?>
</section>
...
<section class="content">
   ...
   <div class="box box-info">
      ...
      if(!empty($content_policy)) {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_content_policy/'.$content_policy['id'] ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      else {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_content_policy' ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      ?>
            ...
            <div class="row">
               <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control" value="<?php if(isset($content_policy)) { echo $content_policy['title']; } ?>">
                     </div>
               </div>
               <div class="col-md-12">
                     <div class="form-group">
                        <label>Footer Heading</label>
                        <input type="text" name="footer_heading" id="footer_heading" class="form-control" value="<?php if(isset($content_policy)) { echo $content_policy['footer_heading']; } ?>">
                     </div>
               </div>
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     ...
                     <textarea name="description" id="description" class="form-control"><?php if(isset($content_policy)) { echo $content_policy['description']; } ?></textarea>
                  </div>
         ...
         <div class="box-footer">
            <button type="submit" class="btn btn-primary"><?php if(!empty($content_policy)) { echo 'Modify'; }else { echo 'save'; } ?></button>
