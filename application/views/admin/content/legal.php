...
<section class="content-header">
   ...
   if(!empty($legal)) {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Edit Legal</h1>
   <?php
   }
   else {
   ?>
   <h1><i class="fa fa-plus"></i>&nbsp;Add Legal</h1>
   <?php
   }
   ?>
</section>
...
<section class="content">
   ...
   <div class="box box-info">
      ...
      if(!empty($legal)) {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_legal/'.$legal['id'] ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      else {
      ?>
      <form role="form" action="<?= ADMIN_LINK.'Content/create_update_legal' ?>" method="post" id="bulletinForm" enctype="multipart/form-data">
      <?php
      }
      ?>
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <input type="text" name="title" id="title" class="form-control" value="<?php if(isset($legal)) { echo $legal['title']; } ?>">
                  </div>
               </div>

               <div class="col-md-12">
                     <div class="form-group">
                        <label>Footer Heading<span class="star-mend">*</span></label>
                        <input type="text" name="footer_heading" id="footer_heading" class="form-control" value="<?php if(isset($legal)) { echo $legal['footer_heading']; } ?>">
                     </div>
               </div>
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <textarea name="description" id="description" class="form-control"><?php if(isset($legal)) { echo $legal['description']; } ?></textarea>
                  </div>
         ...
         <div class="box-footer">
            <button type="submit" class="btn btn-primary"><?php if(!empty($legal)) { echo 'Modify'; }else { echo 'save'; } ?></button>
